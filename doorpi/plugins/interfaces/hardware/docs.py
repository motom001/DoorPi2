...
from plugins.interfaces.docs import DOCUMENTATION as INTERFACEBASECLASS_DOCUMENTATION
...
OUTPUT_CHANNEL_EVENT_PARAMETER = [
    ...
    dict( name = 'low_by_event', type = 'string', default = 'sqllite', mandatory = False, description = 'Parameter 1 der zur Aktion übergeben wird' ),
    dict( name = 'log', type = 'string', default = 'sqllite', mandatory = False, description = 'Parameter 1 der zur Aktion übergeben wird' ),
    dict( name = 'class_name', type = 'string', default = 'sqllite', mandatory = False, description = 'Parameter 1 der zur Aktion übergeben wird' ),
    dict( name = 'module_name', type = 'string', default = 'sqllite', mandatory = False, description = 'Parameter 1 der zur Aktion übergeben wird' ),
    dict( name = 'interface_name', type = 'string', default = 'sqllite', mandatory = False, description = 'Parameter 1 der zur Aktion übergeben wird' ),
    dict( name = 'interface_id', type = 'string', default = 'sqllite', mandatory = False, description = 'Parameter 1 der zur Aktion übergeben wird' ),
] + CHANNEL_EVENT_PARAMETER
